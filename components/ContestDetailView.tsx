        ...
        <div className="space-y-6">
          <div className="bg-slate-800 border-2 border-blue-500 p-8 rounded-[3rem] shadow-2xl sticky top-24">
             ...
             <button 
                ...
                disabled={!canAfford}
                className={`w-full py-6 rounded-[2rem] font-black uppercase text-xs tracking-widest transition-all shadow-xl flex flex-col items-center justify-center gap-1 ${
                  canAfford 
